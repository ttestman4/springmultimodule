...
public class SpringKafkaApp1 {
	...
	@Bean
	public NewTopics springKafkaApp0Demo1Topic() {
	...
	@KafkaListener(id = "sk-app1-demo1-group", topicPartitions = @TopicPartition(topic = "spring-kafka-app1-demo1", partitionOffsets = {
	...
	public void listen1(String in, @Header(KafkaHeaders.RECEIVED_KEY) Long key,
		...
		logger.info("Listener-1:: Data Received : {} with key {} from partition {} and offset {}.", in, key, partition,
				offset);
	}

	@KafkaListener(id = "sk-app1-demo2-group", topicPartitions = @TopicPartition(topic = "spring-kafka-app1-demo2", 
		partitions = "0-1, 4, 6, 8-9", 
	...
	public void listen2(String in, @Header(KafkaHeaders.RECEIVED_KEY) UUID key,
			...
			@Header(KafkaHeaders.OFFSET) int offset) {
				...
				logger.info("Listener-2:: Data Received : {} with key {} from partition {} and offset {}.", in, key, partition,
				offset);
	}
