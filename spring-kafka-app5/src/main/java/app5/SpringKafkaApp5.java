...
public class SpringKafkaApp5 {
    ...
    static class Admin {
        ...
        public NewTopics springKafkaApp5Demo1Topic() {
            return new NewTopics(
                    TopicBuilder.name("spring-kafka-app5-demo")
                            .partitions(1)
                            .replicas(3)
                            .build(),
                    TopicBuilder.name("spring-kafka-app5-demo.DLT")
                            .partitions(1)
                            .replicas(3)
                            .build());
        }
    ...
    static class Listener {
        ...
        @KafkaListener(id = "from.dlt-app5", topics = "spring-kafka-app5-demo.DLT", properties = "value.deserializer:org.apache.kafka.common.serialization.ByteArrayDeserializer")
        public void listenFromDLT(byte[] in, 
                @Header(KafkaHeaders.RECEIVED_PARTITION) int partition,
                @Header(KafkaHeaders.OFFSET) int offset) {
            logger.info("DLT Data Received : {} from partition {} and offset {}.", in,
                    partition,
                    offset);
        }
